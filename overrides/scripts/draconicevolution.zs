...
assembly_line.recipeBuilder()
    ...
    .outputs(<gtmagiccoremod:packresource:16>)
    .duration(6000)
    .EUt(50000)
    .buildAndRegister();
assembler.recipeBuilder()
    ...
    .notConsumable(<gtmagiccoremod:packresource:16>)
...
assembly_line.recipeBuilder()
    ...
    .outputs(<gtmagiccoremod:packresource:17>)
    .duration(12000)
    .EUt(100000)
    .buildAndRegister();
...
assembler.recipeBuilder()
    ...
    .inputs(<draconicevolution:draconic_core>)
    .notConsumable(<gtmagiccoremod:packresource:17>)
