...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("bellows", "BELLOWS",  50, 
	...
	[<backpack:tanned_leather>, pistonLv, <backpack:tanned_leather>], 
	[<thaumcraft:slab_greatwood>, <thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aer"}]}), <thaumcraft:slab_greatwood>]]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("fancy_belt", "BASEARTIFICE",  30, 
	...
	[[<ore:screwRoseGold>, <harvestcraft:hardenedleatheritem>, <ore:screwRoseGold>], 
	[<backpack:tanned_leather>, <ore:gtceScrewdrivers>, <backpack:tanned_leather>], 
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("caster_basic", "UNLOCKAUROMANCY", 200,
...
mods.thaumcraft.Infusion.registerRecipe("blank_greater_focus", "FOCUSGREATER", <thaumcraft:focus_3>, 18, 
	...
	[<bloodmagic:slate:2>, <ore:plateTitanium>, <bloodmagic:slate:2>, <ore:plateTitanium>, <bloodmagic:slate:2>, <ore:plateTitanium>, <bloodmagic:slate:2>, <ore:plateTitanium>]);
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("focus_pouch", "FOCUSPOUCH",  100, 
	...
	[<backpack:tanned_leather>, <thaumcraft:baubles:2>, <backpack:tanned_leather>], 
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("AncientPedestal", "INFUSIONANCIENT", 200,
    [], <thaumcraft:pedestal_ancient>, [
    [<thaumcraft:salis_mundus>, <thaumcraft:slab_ancient>, <thaumcraft:salis_mundus>],
    [<thaumcraft:slab_ancient>, <thaumicaugmentation:material:5>, <thaumcraft:slab_ancient>],
...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("EldritchPedestal", "INFUSIONELDRITCH", 200,
    [], <thaumcraft:pedestal_eldritch>, [
    [<thaumcraft:salis_mundus>, <thaumcraft:slab_eldritch>, <thaumcraft:salis_mundus>],
    [<thaumcraft:slab_eldritch>, <thaumicaugmentation:material:5>, <thaumcraft:slab_eldritch>],
