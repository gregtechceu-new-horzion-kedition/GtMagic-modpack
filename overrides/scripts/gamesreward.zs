...
pool1.addItemEntry(<natura:netherrack_furnace>, 20, 1, [{"count": {"min": 2.0, "max": 4.0}, "function": "minecraft:set_count"}], []);
...
pool1.addItemEntry(<gregtech:steam_casing:2>, 20, 1, [{"count": {"min": 4.0, "max": 8.0}, "function": "minecraft:set_count"}], []);
...
pool1.addItemEntry(<yabba:item_barrel>, 25, 1, [{"count": {"min": 10.0, "max": 20.0}, "function": "minecraft:set_count"}], []);
